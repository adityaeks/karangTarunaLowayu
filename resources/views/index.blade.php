                        ...
                        <div class="row gx-5 d-flex">
                            ...
                            <div class="col-md-5 offset-md-1">
                                <div class="shadow ratio ratio-1x1 rounded bg-cover mt-5 bp-center float-end"
                                    data-aos="fade-up" style="background-image: url(img/webp/interior42.webp);">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="row vw-100 px-0 py-vh-5 d-flex align-items-center scrollx">
                            ...
                            <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                                <img src="img/webp/people2.webp" class="img-fluid rounded shadow"
                                    alt="nice gallery image" width="844" height="1054">
                            </div>

                            <div class="col-md-3" data-aos="fade-up" data-aos-delay="600">
                                <img src="img/webp/interior29.webp" class="img-fluid rounded shadow"
                                    alt="nice gallery image" width="844" height="562">
                            </div>

                            <div class="col-md-2" data-aos="fade-up" data-aos-delay="800">
                                <img src="img/webp/people23.webp" class="rounded shadow img-fluid"
                                    alt="nice gallery image" width="512" height="341">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card p-4 mt-3 border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person9.webp" width="48" height="48"
                                ...
                                <div class="card p-4 shadow mt-3 border-0" data-aos="fade-down">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person3.webp" width="48" height="48"
                                                class="rounded-circle" alt="" data-aos="fade">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card p-4 mt-3 border-0" data-aos="fade-left">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person8.webp" width="48" height="48"
                                                class="rounded-circle" alt="" data-aos="fade">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card p-4 mt-3 border-0" data-aos="fade-right">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person14.webp" width="48" height="48"
                                                class="rounded-circle" alt="" data-aos="fade">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card p-4 mt-3 border-0" data-aos="fade-up">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person13.webp" width="48" height="48"
                                                class="rounded-circle" alt="" data-aos="fade">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card p-4 shadow mt-3 border-0" data-aos="fade-left">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between border-top pt-3">
                                            ...
                                            <img src="img/webp/person18.webp" width="48" height="48"
                                                class="rounded-circle" alt="" data-aos="fade">
                                        </div>
                                    </div>
                                </div>
